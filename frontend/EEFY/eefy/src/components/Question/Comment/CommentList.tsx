...
function CommentList() {
  ...
  useEffect(() => {
    var checkbox = document.getElementById("myCheckbox") as HTMLInputElement; // HTMLInputElement 타입으로 캐스팅
    if (checkbox) {
            ...
            {!item.check ? (
              <>
                <div className="chat chat-start">
                  ...
                  <div className="chat-bubble" style={{fontSize:'12px'}}>{item.comment}</div>
